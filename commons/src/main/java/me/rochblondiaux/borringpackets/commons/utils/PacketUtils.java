...
public class PacketUtils {
    ...
    /**
     * Writes a {@link BorringPacket} into a {@link ByteBuf}.
     *
     * @param buf    the recipient of {@code packet}
     * @param packet the packet to write into {@code buf}
     */
    public static void writePacket(ByteBuf buf, BorringPacket packet) {
     ...
     */
    private static void writePacketPayload(ByteBuf buffer, BorringPacket packet) {
    ...
    public static void writeFramedPacket(ByteBuf buffer, BorringPacket serverPacket) {
     ...
     */
    public static ByteBuf createFramedPacket(BorringPacket serverPacket) {
