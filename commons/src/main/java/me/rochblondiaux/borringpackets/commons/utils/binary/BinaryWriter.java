package me.rochblondiaux.borringpackets.commons.utils.binary;
...
public class BinaryWriter extends OutputStream {
     ...
     */
    public BinaryWriter(ByteBuf buffer) {
        this.buffer = buffer;
    }
    ...
    /**
     * Writes a {@link Date}
     * It's done by writing date milliseconds.
     *
     * @param date the {@link Date} to write.
     */
    public void writeDate(Date date) {
        writeVarLong(date.getTime());
    }
